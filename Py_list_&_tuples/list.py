...
list2.sort() # for shorting the value small number to big number
list2.reverse() # for reversing the values
list2.insert(1,2) # for adding value at any particular index
